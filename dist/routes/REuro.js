 ...
 *        description: Internal server error.
 */
router.get('/', controllers_1.getEuro);
router.get('/entity', controllers_1.getSpecificEuro);
router.get('/toEuro', controllers_1.calculatorBsToEuro);
router.get('/toBs', controllers_1.calculatorEuroToBs);
