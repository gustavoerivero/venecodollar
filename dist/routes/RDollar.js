 ...
 *        description: Internal server error.
 */
router.get('/', controllers_1.getDollar);
router.get('/entity', controllers_1.getSpecificDollar);
router.get('/toDollar', controllers_1.calculatorBsToDollar);
router.get('/toBs', controllers_1.calculatorDollarToBs);
